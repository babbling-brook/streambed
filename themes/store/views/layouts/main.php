...
<meta name="viewport" content="width=device-width">
    <?php if (Yii::app()->user->isGuest === false) { ?>
        ...
        <script type="text/javascript" src="/js/Client/Component/Resize.js"></script>
...
<?php if (Yii::app()->user->isGuest === true) { // If this is a public page then include the login popup.  ?>
...
<div id="page">
    ...
    <?php } else { ?>
        <nav id="top_nav" class="alt-text">
            <?php $this->renderPartial('/layouts/top_nav'); ?>
        </nav>
    <?php } ?>
    ...
    <div class="orange_yellow_bar"></div>
    ...
    <footer>
         		&#169; 2014 Babbling Brook Network Ltd.
    </footer>
...
<div id="templates" class="hide">
    ...
    <script type="text/javascript">
        // If there is a hash url then the content needs clearing as quickly as possible too prevent flicker.

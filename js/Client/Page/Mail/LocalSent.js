 ...
 * @package JS_Client
 */
BabblingBrook.Client.Page.Mail.LocalSent = (function () {
    'use strict';

    return {

        construct : function () {
            BabblingBrook.Client.Page.Mail.changeType('local_sent_private');
        }
...
jQuery(function () {
    'use strict';
    BabblingBrook.Client.Page.Mail.LocalSent.construct();
});
/**
 * *******************************************
 * This is an example of the local config file provided by sails.
 *
 * This file should be copied and named local.js
 *
 * Your local config settings can then be placed in local.js, but it will not
 * be commited to git as it is in .gitignore.
 *
 * *******************************************
 *
 *

...
/**
 * View for the base template for the ring subdomain.
 */
...
$cs = Yii::app()->getClientScript();if (Yii::app()->params['minify'] === true) {
    $cs->registerScriptFile(Yii::app()->baseUrl . '/js/Minified/ring.js' . $this->js_version_number);
} else {
    ...
    $cs->registerScriptFile(Yii::app()->baseUrl . '/js/ring/ring.js' . $this->js_version_number);
}
?>

...
/**
 * View for the base template for the filter subdomain.
 */
...
if (Yii::app()->params['minify'] === true) {
    $cs->registerScriptFile(Yii::app()->baseUrl . '/js/Minified/filter.js' . $this->js_version_number);
} else {
    ...
    $cs->registerScriptFile(Yii::app()->baseUrl . '/js/Filter/filter.js' . $this->js_version_number);
}
?>

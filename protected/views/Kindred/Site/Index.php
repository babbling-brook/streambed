...
/**
 * View for the base template for the kindred subdomain.
 */
...
$cs = Yii::app()->getClientScript();if (Yii::app()->params['minify'] === true) {
    $cs->registerScriptFile(Yii::app()->baseUrl . '/js/Minified/kindred.js' . $this->js_version_number);
} else {
    ...
    $cs->registerScriptFile(Yii::app()->baseUrl . '/js/Kindred/kindred.js' . $this->js_version_number);
}
?>

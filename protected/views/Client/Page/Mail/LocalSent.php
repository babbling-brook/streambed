 ...
 *
 */
$this->pageTitle=Yii::app()->name . ' - Local Sent Items';

$this->renderPartial('/Shared/Layouts/_page_js', array('page' => 'Mail'));
$this->renderPartial('/Shared/Layouts/_page_js', array('page' => 'Mail/LocalSent'));
...
<h2>Local Sent Items</h2>

<div class="content-indent post-box">

    <div class="content-block">
        Posts that you have made on <?php echo Yii::app()->name; ?>
    </div>

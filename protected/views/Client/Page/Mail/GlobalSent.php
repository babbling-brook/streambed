 ...
 *
 */
$this->pageTitle=Yii::app()->name . ' - Global Sent Items';

$this->renderPartial('/Shared/Layouts/_page_js', array('page' => 'Mail'));
$this->renderPartial('/Shared/Layouts/_page_js', array('page' => 'Mail/GlobalSent'));
...
<h2>Global Sent Items</h2>

<div class="content-indent post-box">

    <div class="content-block">
        Posts that you made on all sites in the BabblingBrook network.
    </div>

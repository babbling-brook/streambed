...
/**
 * View for testing the filter subdomain.
 */
...
$cs->registerScriptFile(Yii::app()->baseUrl . '/js/tests/test_filter.js');
...
<h1 id="qunit-header">BabblingBrookFilterActions Tests</h1>
<h2 id="qunit-banner">
    Test BabblingBrookFilterActions by sending requests to the filter domain and checking returned results.
</h2>

...
$cs->registerScriptFile(Yii::app()->baseUrl . '/js/tests/test_suggestion.js');
...
<h1 id="qunit-header">BabblingBrookSuggestionActions Tests</h1>
<h2 id="qunit-banner">
    Test BabblingBrookSuggestion Actions by sending requests to the suggestion domain and checking returned results.
</h2>

...
/**
 * View for testing the kindred subdomain.
 */
...
$cs->registerScriptFile(Yii::app()->baseUrl . '/js/tests/test_kindred.js');
$cs->registerScriptFile(Yii::app()->baseUrl . '/js/domus/interact.js');
...
<h1 id="qunit-header">BabblingBrookKindredActions Tests</h1>
<h2 id="qunit-banner">
    Test BabblingBrookKindred Actions by sending requests to the kindred domain and checking returned results.
</h2>

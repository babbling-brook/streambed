...
/**
 * Model to validate requests to search for streams.
 *
 * @package PHP_Model_Forms
 */
class StreamSearchForm extends CFormModel
{
    ...
    /**
     * The type of selection being tested. See $valid_types for valid options.
     *
     * @var string
     */
    public $kind;
    ...
    /**
     * The page of results this selection represents.
     *
     * @var integer
     */
    public $page;
    ...
    /**
     * The kind of stream. See lookup table (stream.kind) for options.
     *
     * @var string
     */
    public $stream_kind;
    ...
    public function ruleKind() {
        if (isset($this->kind) === true && strlen($this->kind) > 0) {
            if (is_null(LookupHelper::getID('stream.kind', $this->kind, false)) === true) {
                $this->addError('kind', 'stream_kind is invalid : ' . $this->kind);
            }
        } else {
            $this->kind = '';
        }
    ...
    public function ruleSortOrder() {
        $valid_sort_keys = array('domain', 'username', 'name', 'version', 'status', 'stream_kind');
    ...
    public function ruleSortPriority() {
        $valid_sort_columns = array('domain', 'username', 'name', 'version', 'status', 'stream_kind');

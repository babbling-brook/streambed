<?php //[STAMP] 466e67c5a9c9e9d09c972c6531c22aeb
...
class AcceptanceTester extends \Codeception\Actor
{
     ...
     *
     *
     * @see \Codeception\Module\AcceptanceHelper::getWindowWidth()
     */
    public function getWindowWidth($I) {
        return $this->scenario->runStep(new \Codeception\Step\Action('getWindowWidth', func_get_args()));
    }
     ...
     * @see \Codeception\Module\AcceptanceHelper::assertAttributeContent()
     */
    public function assertAttributeContent($I, $path, $attribute, $content) {
        return $this->scenario->runStep(new \Codeception\Step\Action('assertAttributeContent', func_get_args()));
    }
     ...
     * @param string $path The path to check.
     * @param string $id The id to assert is found at the end of the path.
     * @see \Codeception\Module\AcceptanceHelper::assertIdInCorrectLocation()
     */
    public function assertIdInCorrectLocation($I, $path, $id) {
        return $this->scenario->runStep(new \Codeception\Step\Action('assertIdInCorrectLocation', func_get_args()));
    }
     ...
     * @param string $path The path to check.
     * @param string $id The id to assert is found at the end of the path.
     * @see \Codeception\Module\AcceptanceHelper::assertClassInCorrectLocation()
     */
    public function assertClassInCorrectLocation($I, $path, $class) {
        return $this->scenario->runStep(new \Codeception\Step\Action('assertClassInCorrectLocation', func_get_args()));
    }
     ...
     * @see \Codeception\Module\AcceptanceHelper::assertHeight()
     */
    public function assertHeight($I, $path, $height) {
        return $this->scenario->runStep(new \Codeception\Step\Action('assertHeight', func_get_args()));
    }
     ...
     * @see \Codeception\Module\AcceptanceHelper::assertWidth()
     */
    public function assertWidth($I, $path, $width) {
        return $this->scenario->runStep(new \Codeception\Step\Action('assertWidth', func_get_args()));
    }
     ...
     * @see \Codeception\Module\AcceptanceHelper::assertContent()
     */
    public function assertContent($I, $path, $content) {
        return $this->scenario->runStep(new \Codeception\Step\Action('assertContent', func_get_args()));
    }
     ...
     * @param type $path The css path to the element.
     * @param type $content The expected content of the element.
     * @see \Codeception\Module\AcceptanceHelper::assertLocation()
     */
    public function assertLocation($I, $path, $x, $y) {
        return $this->scenario->runStep(new \Codeception\Step\Action('assertLocation', func_get_args()));
    }
     ...
     * @see \Codeception\Module\AcceptanceHelper::assertCSSValue()
     */
    public function assertCSSValue($I, $path, $css_property, $value) {
        return $this->scenario->runStep(new \Codeception\Step\Action('assertCSSValue', func_get_args()));
    }
     ...
     * @see \Codeception\Module\AcceptanceHelper::makeStreamURL()
     */
    public function makeStreamURL($stream) {
        return $this->scenario->runStep(new \Codeception\Step\Action('makeStreamURL', func_get_args()));
    }
}

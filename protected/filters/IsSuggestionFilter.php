...
/**
 * Attatched to methods that are allowed to be accessed in the filter.host domain
 * $is_suggestion must be defined in the controller.
 *
 * @package PHP_Filter
 */
class IsSuggestionFilter Extends CFilter
{

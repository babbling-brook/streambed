...
/**
 * Attatched to methods that are allowed to be accessed in the client domain
 * $is_client must be defined in the controller
 *
 * @package PHP_Filter
 */
class IsClientFilter Extends CFilter
{

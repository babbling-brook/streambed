...
/**
 * Attatched to methods that are allowed to be accessed in the rhythm.host domain
 * $is_kindred must be defined in the controller.
 *
 * @package PHP_Filter
 */
class IsKindredFilter Extends CFilter
{

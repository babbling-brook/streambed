...
/**
 * Attatched to methods that are allowed to be accessed by the scientia javascript domain
 * $is_scientia must be defined in the controller.
 *
 * @package PHP_Filter
 */
class IsScientiaFilter Extends CFilter
{

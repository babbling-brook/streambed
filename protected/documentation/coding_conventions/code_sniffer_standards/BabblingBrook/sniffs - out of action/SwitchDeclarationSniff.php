<?php
/**
 * BabblingBrook_Sniffs_ControlStructures_SwitchDeclarationSniff.
 *
 * Adapted by Sky Wickenden 26/03/2012 to make switch statments comply with JSLint style.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class BabblingBrook_Sniffs_ControlStructures_SwitchDeclarationSniff implements PHP_CodeSniffer_Sniff
{

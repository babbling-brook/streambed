<?php
/**
 * BabblingBrook_Sniffs_Functions_ValidFunctionNameSniff.
 *
 * Abapted on 26/03/2012 by Sky Wickenden to remove necessity for underscores on private functions.
 * Psudo package naming convention has also been removed.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class BabblingBrook_Sniffs_Functions_ValidFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        // All methods must not be preceeded by an underscore.
